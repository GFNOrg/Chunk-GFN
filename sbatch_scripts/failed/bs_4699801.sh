...
python main.py \
experiment=bit_sequence_prioritized \
task_name=bit_sequence \
seed=2024 \
ckpt_path="/network/scratch/o/oussama.boussif/chunkgfn/logs/bit_sequence/runs/4699801/checkpoints/last.ckpt" \
data.max_len=64 \
gfn.chunk_algorithm=bpe \
gfn.n_samples=10000 \
gfn.replay_buffer.cutoff_distance=12 \
gfn.reward_temperature=0.3333333333333333 \
logger.wandb.name=bit_sequence_prioritized_64_bpe \
logger.wandb.group=bit_sequence \
logger.wandb.id=4699801 \
