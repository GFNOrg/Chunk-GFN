...
exec python main.py experiment=bit_sequence_chunking_prioritized.yaml task_name=bit_sequence seed=1 data.max_len=64 gfn.chunk_algorithm=bpe gfn.n_samples=10000 gfn.pb='kolya' gfn.replay_buffer.cutoff_distance=12 gfn.reward_temperature=0.3333333333333333 logger.wandb.name=bit_sequence_chunking_prioritized_64_True_bpe logger.wandb.group=bit_sequence